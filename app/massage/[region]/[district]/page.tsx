...
const titleTemplates = [
  (loc: string) => `${loc} 지역 맞춤형 스웨디시 마사지 안내 - 메트로힐`,
  ...
  (loc: string) => `${loc} 힐링 에스테틱 스킨 바디 마사지 정보 - 메트로힐`,
    ...
    <div className="bg-[#070709] text-gray-100 min-h-screen flex flex-col font-sans selection:bg-amber-500 selection:text-black pb-24">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 w-full flex-1 space-y-10">
        ...
        <div className="text-center pt-2">
          <Link href={`/`} className="text-xs text-gray-400 hover:text-amber-400 transition-colors font-semibold">
            ← 메인 홈으로 돌아가기
          </Link>
        </div>
      </main>
